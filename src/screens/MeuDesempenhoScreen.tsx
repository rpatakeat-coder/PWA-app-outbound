...
const styles = StyleSheet.create({
  ...
  periodChip: { flex: 1, paddingVertical: 10, borderRadius: 10, backgroundColor: '#fff', alignItems: 'center', borderWidth: 1, borderColor: '#e2e8f0' },
  periodChipActive: { backgroundColor: '#dc2626', borderColor: '#dc2626' },
  periodChipText: { fontSize: 13, fontWeight: '600', color: '#64748b' },
  periodChipTextActive: { color: '#fff' },
  sectionTitle: { fontSize: 13, fontWeight: '700', color: '#94a3b8', textTransform: 'uppercase', letterSpacing: 0.5, marginTop: 8, marginBottom: 10 },
  grid: { flexDirection: 'row', flexWrap: 'wrap', gap: 8, marginBottom: 12 },
  statCard: { flexBasis: '48%', flexGrow: 1, backgroundColor: '#fff', borderRadius: 12, padding: 14, borderWidth: 1, borderColor: '#e2e8f0' },
  statValue: { fontSize: 24, fontWeight: '800' },
  statLabel: { fontSize: 12, color: '#64748b', marginTop: 2, fontWeight: '600' },
  assignedCard: { backgroundColor: '#fff', borderRadius: 12, padding: 16, borderWidth: 1, borderColor: '#e2e8f0' },
  assignedNumber: { fontSize: 28, fontWeight: '800', color: '#0f172a' },
  assignedLabel: { fontSize: 13, color: '#64748b', fontWeight: '600' },
  statusBreakdown: { flexDirection: 'row', flexWrap: 'wrap', gap: 6, marginTop: 12 },
  statusChip: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#f1f5f9', paddingHorizontal: 8, paddingVertical: 4, borderRadius: 12, gap: 4 },
  ...
  footerHint: { marginTop: 20, textAlign: 'center', fontSize: 11, color: '#94a3b8', fontStyle: 'italic' },
  modalBackdrop: { flex: 1, backgroundColor: 'rgba(15,23,42,0.55)', justifyContent: 'flex-end' },
  modalPanel: { maxHeight: '75%', backgroundColor: '#fff', borderTopLeftRadius: 18, borderTopRightRadius: 18, paddingHorizontal: 16, paddingTop: 14, paddingBottom: 8 },
  modalHeader: { flexDirection: 'row', alignItems: 'flex-start', gap: 12, marginBottom: 10, paddingBottom: 10, borderBottomWidth: 1, borderBottomColor: '#f1f5f9' },
  modalTitle: { fontSize: 16, fontWeight: '800', color: '#0f172a' },
  modalSubtitle: { fontSize: 12, color: '#64748b', marginTop: 2 },
  modalClose: { backgroundColor: '#f1f5f9', paddingHorizontal: 12, paddingVertical: 6, borderRadius: 8 },
  ...
  leadMeta: { fontSize: 11, color: '#64748b', marginTop: 1 },
  leadNote: { fontSize: 13, color: '#334155', marginTop: 6, lineHeight: 18, backgroundColor: '#f8fafc', borderRadius: 8, paddingVertical: 8, paddingHorizontal: 10, borderLeftWidth: 3, borderLeftColor: '#facc15' },
});
