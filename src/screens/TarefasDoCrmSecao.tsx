  ...
  return (
    <View style={estilos.bloco}>
      ...
      {grupos.map((g) => {
        ...
        // TUDO recolhido por padrão. A seção fica ABAIXO do Kanban, e o Kanban
        // é a visão principal — em 14/09/2026 esta seção aberta no topo
        // empurrava as três colunas para fora da tela, no celular e no
        // navegador. Aberta por toque, e o estado dura a sessão.
        const expandido = aberto[g.chave] ?? false;
        return (
