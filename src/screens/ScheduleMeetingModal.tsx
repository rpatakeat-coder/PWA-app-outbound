...
const styles = StyleSheet.create({
  ...
  subtitle: { fontSize: 13, color: 'var(--text-muted)', marginBottom: 8 },
  label: {
    fontSize: 12,
    fontWeight: '700',
  ...
  meetingDate: { fontSize: 14, fontWeight: '600', color: 'var(--text)' },
  meetingObs: { fontSize: 12, color: 'var(--text-muted)', marginTop: 2 },
  meetingDelete: {
    backgroundColor: 'var(--tint-red)',
    borderWidth: 1,
    borderColor: 'var(--tint-red-border)',
