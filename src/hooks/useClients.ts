...
export function useClients(
  ...
  const markAsVisited = useMutation({
    mutationFn: async ({
      ...
      // 0109: fora do raio, o executivo declara que esteve lá. Conta como
      // visita; client_visits.declarada separa na medição (GPS × declarada).
      declarada?: boolean;
    }) => {
