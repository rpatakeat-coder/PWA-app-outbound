...
**Referência visual:** o preview `Cockpit de Gestão - Casca web.dc.html`, aba **Semana**
**Pergunta que a tela responde:** *O que mudou e o que eu faço?* — é o subtítulo no header, e o critério para decidir o que fica e o que sai
...
## Duas metades, uma pergunta cada

O título é montado em tempo de execução em dois pontos (L72 e L311) — **preserve a lógica**, aplique só o estilo.

## O que fazer

**Faixa de KPIs** em 4 colunas: entraram no funil · avançaram · perdidos · parados 7+ dias. Os dois últimos com delta em `--red` quando pioram.

**Grade `12fr`** — largura cheia, dois blocos empilhados. A tela é de leitura, não de comparação lado a lado.

**O que mudou de etapa** — nota com o intervalo da semana. Barras de 20px, mas o rótulo é a **transição**, não a etapa: "Prospecção → Visita", "Demo → Ag. Pagamento". A cor é a da etapa de **destino** — é para onde o lead foi que interessa. A última barra é "Qualquer etapa → Perdido" em `#475569`.

**Exige decisão sua** — o segundo bloco é a resposta ao "o que eu faço". Linha sem avatar: nome do lead 14/20/0.1 peso 600, sublinha 12/16/0.4 `--ter` com **etapa, tempo parado e responsável**, e badge com o motivo — "Desconto pedido", "Sem retorno", "Escalar".

Se o `semana.ts` não tiver um recorte de "exige decisão", **diga e pare**. É o bloco que dá sentido à segunda metade da pergunta, e inventar critério aqui é pior que não ter o bloco.
