...
- **Corpo** (`flex:1; overflow-y:auto; padding:24px`, gap 24):
  ...
  - **Dados** — cabeçalho de seção 12/16/0.5 peso 700 uppercase `--text-muted`. Pares chave/valor: `padding:10px 0`, borda inferior 1px `--border`, chave 12/16/0.5 peso 600 `--text-faint` à esquerda, valor 14/20/0.25 `--text` à direita
